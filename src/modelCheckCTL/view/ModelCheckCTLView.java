...
/**
 * This object is the main object and creates the GUI for the user.
 * It allows a file representing a Kripke Structure to be loaded.
 * It takes a CTL formula and a starting state from the user.
 * Buttons exist to submit all of these items. 
...
public class ModelCheckCTLView extends JFrameView {
	 ...
	 * @param controller
	 */
	public ModelCheckCTLView(ModelCheckCTLModel model, ModelCheckCTLController controller) { 
		...
		startState.setText("Enter Starting State");//TODO set default for testing
	...
	/* (non-Javadoc)
	 * @see modelCheckCTL.model.ModelListener#modelChanged(modelCheckCTL.model.ModelEvent)
	 */
	...
	class Handler implements ActionListener { 
		...
		public void actionPerformed(ActionEvent e) {
			...
			((ModelCheckCTLController)getController()).operation(e.getActionCommand()); 
		} 
	}//class Handler
	 ...
	 * @param args
	 */
	public static void main(String [] args) { new ModelCheckCTLController(); }

	// getters and setters
	public JTextArea getLog() { return log; }
	public void setLog(JTextArea log) { this.log = log; }
	public JTextField getCtlFormula() { return ctlFormula; }
	public JTextField getStartState() { return startState; }
	public void setStartState(JTextField startState) { this.startState = startState; }
	public void setCtlFormula(JTextField ctlFormula) { this.ctlFormula = ctlFormula; }
	public JFileChooser getFc() { return fc; }
	public void setFc(JFileChooser fc) { this.fc = fc; }
	public int getReturnVal() { return returnVal; }
	public void setReturnVal(int returnVal) { this.returnVal = returnVal; }
