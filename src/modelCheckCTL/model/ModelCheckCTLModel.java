 ...
 * kripke structure to find out if it is satisfied.
 * It will send the results back to the view object.
 * @author ssiroky
 *
 */
...
public class ModelCheckCTLModel extends AbstractModel {
	...
	/**
	 * Give a file that represents a kripke structure parse it and create 
	 * a kripke structure for it.
	 * @param f File handle
	 */
	...
	/**
	 * Run the model to check the Kripke Structure 
	 * need a valid kripke structure, starting state and formula.
	 * @param ss String for the starting state
	 */
